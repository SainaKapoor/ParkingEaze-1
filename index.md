<html>
  <head>
    ...
    <p> I was struggling with my motor working but it finally works as their some voltage and current specifications on the driver needs to be cahnged with the multimeter probes.Alongwith it ,the motor wires to the driver were connected in a wrong manner,so that implements the alterations on the pcb design.I soldered the new pcb with changed connections of wire alongwith adding  power supply holes too as i am using a 12 v power supply for the motor.I am working for my  enclosure case as this is the very next step after the powering up of the pcb. I also ordered the hdmi to vga cable and bought a  mouse and a keyboard combo in order for running code on raspberry pi that also implies my changes in the financial status.My budget has also been changed a bit as I ordered bunch of headers from amazon due to changing of my designs of the pcb</p>
      <h2>Nov 14 ,2019 </h2>
